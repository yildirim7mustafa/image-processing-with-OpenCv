...
#blurring (detay azaltır, gürültüyü engeller)
...
# içe aktar normalize et -> 0-255 arası değişen değerleri 0-1 arasına taşımak çünkü gürültü öyle
img = cv2.imread("NYC.jpg")
img = cv2.cvtColor(img,cv2.COLOR_BGR2RGB)/255
plt.figure(),plt.imshow(img),plt.axis("off"),plt.title("original")

gaussianNoiseImage = gaussianNoise(img)
plt.figure(),plt.imshow(gaussianNoiseImage),plt.axis("off"),plt.title("Gauss Noise")
